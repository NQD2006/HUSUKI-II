...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r " + Fore.MAGENTA + "[*]" + Fore.GREEN + " ATTACK SENT  " + str(
...
wms = [
  ...
  '''    
        \033[35m           ╦ ╦╦ ╦\033[0;36m╔═╗╦ ╦\033[0;31m╦╔═╦  \033[32m╦╦
        \033[35m           ╠═╣║ ║\033[0;36m╚═╗║ ║\033[0;31m╠╩╗║  \033[32m║║
         \033[35m          ╩ ╩╚═╝\033[0;36m╚═╝╚═╝\033[0;31m╩ ╩╩  \033[32m╩╩    
...
def inputf():
  ...
  ╔═══[dungtideptrai@\033[0;36mHUSUKI \033[0;31mII]
  ╚══> ''', True), end=' ')
...
def welcome():
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.blue_to_green, f'''
           ...
           ╩══╦═════════════════════════════════╦══╩
    ╔═════════╩═════════════════════════════════╩═════════╗
    |              Welcome to \033[0;31mHUSUKI SCREEN               |
    |          \033[0;36m Full Methods Layer7 Bypasser              |
    |                                                     |
    ╠═════════╦═════════════════════════════════╦═════════╣
              | Type [help] To See All Commands |
           ╦══╩═════════════════════════════════╩══╦
                  Full Power By Cypher Team 
                  Copyright @2022 by Dũng Tí     
           ╩══╦═════════════════════════════════╦══╩
    ╔═════════╩═════════════════════════════════╩═════════╗
  ...
  while True:
    ...
    if 'credit' in cmdl:
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        - Bản quyền            : Dũng Tí-GOD DDOS
        - ZALO                 : 0397390284
                     CẢM ƠN ĐÃ SỬ DỤNG HUSUKI
...
\033[35m           ╩═╝╩ ╩ ╩ ╚═╝╩╚═  ╩ ╚╝ 
  ...
  -tcpc    | Ddos IP TCP tùy chỉnh
      ...
      '''), True), end='')
        ...
        global ip
        print(Back.BLUE+"IP của bạn: {}".format(ip)+Style.RESET_ALL)
